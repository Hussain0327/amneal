...
class CellSpec:
    ...
    section: str
    label: str
    source: str  # human-facing source label ("Orange Book", "Drugs@FDA", ...)
...
CELL_SPECS: tuple[CellSpec, ...] = (
    ...
    CellSpec(
        ...
        "Drug Shortages (DSS)",
        "Retired source; analyst input required under FDA corpus policy",
        CellMode.AUTO,
        "shortage",
    ),
    CellSpec(
    ...
    CellSpec(
        ...
        "Indications and Usage section (application_number/page)",
    ...
    CellSpec(
        ...
        "REMS",
        "analyst input",
        "not acquired by the authoritative corpus",
        CellMode.AUTO,
        "rems",
    ),
    CellSpec(
    ...
    CellSpec(
        ...
        "Labeling Images",
        "Drugs@FDA approved labeling",
        "approved label PDF pages (application_number)",
        CellMode.EVIDENCE_ONLY,
        "spl_media",
    ),
    CellSpec(
        ...
        "Approved labeling in Drugs@FDA corpus",
        "approved label text / EPC indexing (application_number/page)",
        CellMode.EVIDENCE_ONLY,
        "epc",
    ),
    CellSpec(
        ...
        "Drugs@FDA approved labeling",
        "Highlights + numbered-section heuristic (application_number/page)",
        CellMode.EVIDENCE_ONLY,
        "plr_format",
    ),
    CellSpec(
    ...
    CellSpec(
        ...
        "Drugs@FDA approved labeling",
        "Pregnancy/Lactation subsection presence (application_number/page)",
        CellMode.EVIDENCE_ONLY,
        "pllr_format",
    ),
    CellSpec(
        ...
        "Drugs@FDA approved labeling",
        "text scan within the Pregnancy subsection (application_number/page)",
        CellMode.EVIDENCE_ONLY,
        "pregnancy_registry",
    ),
    CellSpec(
    ...
    CellSpec(
        ...
        "Drugs@FDA approved labeling / analyst input",
        "approved label packaging text (application_number/page)",
        CellMode.AUTO,
        "packaging",
    ),
    CellSpec(
    ...
    CellSpec(
        ...
        "Approved labeling in Drugs@FDA corpus",
        "Analyst input; no approved corpus field",
        CellMode.EVIDENCE_ONLY,
        "dea",
    ),
